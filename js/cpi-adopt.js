...
function renderCPIAdopt(data) {
  ...
  html += '<div class="card-header fw-semibold d-flex align-items-center justify-content-between flex-wrap gap-2">';
  html += '<span class="position-relative pe-2">By Use Case <span class="position-absolute text-danger fw-bold" style="top:-4px;right:-4px;font-size:0.5rem;line-height:1">NEW</span> <small class="fw-normal text-muted">All Time</small> <i class="bi bi-info-circle text-muted" style="font-size:0.75rem;cursor:default" data-bs-toggle="tooltip" data-bs-placement="top" title="Number of opt-ins or estimated amount of earned incentives per use case."></i></span>';
